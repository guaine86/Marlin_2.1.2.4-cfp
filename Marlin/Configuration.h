...
#define CUSTOM_MACHINE_NAME "Impresora ICSJ"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 75.10
  #define DEFAULT_bedKi 7.77
  #define DEFAULT_bedKd 483.7
...
//
//  If CLOCKWISE normally moves DOWN this makes it go DOW.
